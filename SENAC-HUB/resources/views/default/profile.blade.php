        ...
        <div class="col-md-12">
            <div id="content" class="content content-full-width">
                    ...
                    <div class="profile-header">
                        ...
                        <div class="profile-header-content">
                            ...
                            <div class="profile-header-img">
                                <img src="{{ Auth::user()->image_link_user }}" alt="">
                            </div>
                            <!-- END profile-header-img -->
                            <!-- BEGIN profile-header-info -->
                            <div class="profile-header-info">
                                <h4 class="m-t-10 m-b-5">{{ Auth::user()->name }}</h4>
                                <p class="m-b-10">Curso</p>
                                <p class="m-b-10">{{ Auth::user()->unidade }}</p>
                                <a href="#" onclick="window.location='{{ route('profile.edit') }}'" class="btn btn-sm btn-info editar-perfil">Editar Perfil</a>
                            </div>
                        ...
                        <ul class="profile-header-tab nav nav-tabs">
                            ...
                            <li class="nav-item"><a href="" target="__blank" class="nav-link_ ">AMIGOS</a></li>
                        </ul>
                ...
                <div class="profile-content">
                        ...
                        <div class="tab-pane fade active show" id="profile-post">
                            ...
                            <li>
                                ...
                                <div class="timeline-comment-box">
                                    <div class="user"><img src="{{ Auth::user()->image_link_user }}"></div>
                                    <div class="input">
                                        <form action="">
                                            <div class="input-group">
                                                <input type="text" class="form-control rounded-corner" placeholder="Começar publicação">
                                                <span class="input-group-btn p-l-10">
                                                    <button class="btn btn-primary f-s-12 rounded-corner btn_comentar" type="button">Comentar</button>
                                                </span>
                                            </div>
                                        </form>
                                    </div>
                    ...
                    if (request()->has('btn_meuperfil')) {
                    if (Auth::check()) {
                    $userId = Auth::id(); // Obtém o ID do usuário autenticado
                    $userPosts = App\Models\Post::where('user_id', $userId)->get(); // Obtém as postagens do usuário
                    } else {
                    // Se o usuário não estiver autenticado, redirecione para a página de login
                    return redirect()->route('login')->with('error', 'Faça login para acessar seu perfil.');
                    }
                    } else {
                    // Se o botão não foi pressionado, mantenha os dados como estão
                    ...
                    <ul>
                        ...
                        <div>
                            ...
                            <div class="publicacao">
                                ...
                                @else
                                <img class="tamanho_perfil" src="/imagens/avatar.svg" alt="Imagem avatar SVG">
                                @endif
                                ...
                                <div class="botoes-like-dislike">
                                    <button type="button" class="btn-like" onclick="aumentarLikes()"><i class="bi bi-hand-thumbs-up" style="font-size: 15px;"></i> <span class="contador-likes" id="likes">0</span></button>
                                    ...
                                    <div style="display: none;">
                                        ...
                                        <div class="card mt-2">
                                            <div class="card-body">
                                                ...
                                                <img class="perfil_img" src="{{ $reply->user->image_link_user }}" alt="Imagem de Perfil">
                                                @else
                    ...
                    @else
                    <p>O usuário não tem postagens.</p>
                    @endif
